ig.baked = true;
ig.module('game.entities.zombie').requires('plugins.twopointfive.entity', 'game.entities.particle').defines(function() {
    EntityZombie = tpf.Entity.extend({
        ...
        gotHit2: false,
        gotHit3: false,
        animSheet: new ig.AnimationSheet('media/zombie.png', 56, 62),
